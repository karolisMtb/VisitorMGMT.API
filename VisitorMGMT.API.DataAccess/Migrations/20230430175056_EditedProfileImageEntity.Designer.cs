...
namespace VisitorMGMT.API.DataAccess.Migrations
{
    ...
    [Migration("20230430175056_EditedProfileImageEntity")]
    partial class EditedProfileImageEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VisitorMGMT.API.DataAccess.Entities.ProfileImage", b =>
                {
                    b.HasOne("VisitorMGMT.API.DataAccess.Entities.Profile", "Profile")
                        ...
                        .HasForeignKey("VisitorMGMT.API.DataAccess.Entities.ProfileImage", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
